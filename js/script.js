document.addEventListener('DOMContentLoaded', () => {
  ...
  const I18N = { fr: {}, en: {
    ...
    'cathero.fauteuils.title': '<span class="line"><span class="word">Our</span> <span class="word">armchair</span> <span class="word">&amp;</span></span><span class="line accent"><span class="word">sofa</span> <span class="word">collection</span></span>',
    'cathero.fauteuils.desc': 'Solid wood frames, cushions and seats dressed in authentic margoum weaving. Living-room comfort, the memory of the loom.',
    'cathero.chaises.title': '<span class="line"><span class="word">Our</span> <span class="word">chair</span></span><span class="line accent"><span class="word">collection</span></span>',
    'cathero.chaises.desc': 'Turned light-wood legs, hand-woven backs and seats — every chair carries a different margoum pattern, never two alike.',
    'cathero.chaisesRondes.title': '<span class="line"><span class="word">Our</span> <span class="word">round</span></span><span class="line accent"><span class="word">chair</span> <span class="word">collection</span></span>',
    'cathero.chaisesRondes.desc': 'A signature silhouette with an enveloping back, designed as an accent piece — margoum in its full glory in a corner of the room.',
    'cathero.poufs.title': '<span class="line"><span class="word">Our</span> <span class="word">pouf</span></span><span class="line accent"><span class="word">collection</span></span>',
    'cathero.poufs.desc': 'For the living room as much as the terrace — soft poufs fully covered in margoum, easy to move, impossible to ignore.',
    'cathero.salonExt.title': '<span class="line"><span class="word">Our</span> <span class="word">outdoor</span></span><span class="line accent"><span class="word">lounge</span> <span class="word">collection</span></span>',
    'cathero.salonExt.desc': 'Wrought-iron frames, weather-resistant margoum cushions — to dress a terrace or garden without losing the artisanal soul.',
    'cathero.tables.title': '<span class="line"><span class="word">Our</span> <span class="word">tables</span> <span class="word">&amp;</span></span><span class="line accent"><span class="word">accessories</span> <span class="word">collection</span></span>',
    'cathero.tables.desc': 'Solid wood with touches of margoum weaving to complete your interior — the collection is coming soon.',
    'cathero.tapis.title': '<span class="line"><span class="word">Our</span> <span class="word">margoum</span></span><span class="line accent"><span class="word">rug</span> <span class="word">collection</span></span>',
    'cathero.tapis.desc': 'The original rug, hand-woven on a vertical loom — traditional geometric patterns from Kairouan, in natural wool.',
    'cathero.deco.title': '<span class="line"><span class="word">Our</span> <span class="word">décor</span> <span class="word">&amp;</span></span><span class="line accent"><span class="word">knife</span> <span class="word">collection</span></span>',
    'cathero.deco.desc': 'Hand-forged knives with margoum-dressed handles, and woven cushions to extend the spirit of the workshop — the collection is coming soon.',
    'trust3.authentic': 'Authentic craftsmanship',
    'trust3.careShip': 'Careful shipping',
    'sidebar.armchairsSofas': 'Armchairs &amp; Sofas',
    'sidebar.poufsAlt': 'Poufs &amp; Low Seating',
    'sidebar.outdoorAlt': 'Outdoor Lounge',
  } };
